...
void Lab9::Update(float deltaTimeSeconds)
{
    ...
    {
        bonus_value_mix = 1; // mix de culori activ doar pt cub
        bonus_value_translate_2 = 0; // translatie_1 activ doar pt sfera
        bonus_value_translate_1 = 0; // translatie_2 activ doar pentru iarba
    ...
    {
        bonus_value_mix = 0; // mix de culori activ doar pentru cub
        bonus_value_translate_1 = 0; // translate_1 activ doar pentru iarba
        bonus_value_translate_2 = 1; // translate_2 activ doar pentru sfera
    ...
    {
        bonus_value_mix = 0; // mix de culori activ doar pentru cub
        bonus_value_translate_2 = 0; // translate_2 activ doar pentru sfera
        bonus_value_translate_1 = 0; // translate_1 activ doar pentru iarba
...

    {
        bonus_value_mix = 0;
        bonus_value_translate_2 = 0; // translate_2 activ doar pentru sfera
        bonus_value_translate_1 = 1; // translate_1 activ doar pentru iarba
...
void Lab9::RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 & modelMatrix, Texture2D* texture1, Texture2D* texture2)
{
    ...
    // 
    // trimit o variabila care determina daca fac un mix de culori 
    int mixed_location = glGetUniformLocation(shader->program, "mixed");
    glUniform1i(mixed_location, bonus_value_mix);

    // TODO: Acestea sunt pentru bonus
    
    // trimit valoarea pentru timp catre shader
    int location4 = glGetUniformLocation(shader->GetProgramID(), "time");
    glUniform1f(location4, time);

    // trimit valoarea pentru translate_1 catre shader 
    int translate_location = glGetUniformLocation(shader->program, "trans1");
    glUniform1i(translate_location, bonus_value_translate_2);

    // trimit valoarea pentru translate_2 pentru bonus
    int rotate_location = glGetUniformLocation(shader->program, "trans2");
    glUniform1i(rotate_location, bonus_value_translate_1);
